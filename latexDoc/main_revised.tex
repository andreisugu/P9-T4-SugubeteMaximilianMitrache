...
\begin{figure}[htbp]
    ...
    \caption{User Classes: System Use Case Diagram.}
    \label{fig:img1}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.49\textwidth}
        ...
        \caption{Administration \& Audit - Query Monitor.}
        \label{fig:img13}
    \end{minipage}
\end{figure}
