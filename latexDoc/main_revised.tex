...
\midrule
PDF Renderer & PDF-Gen & Implementation Dependent & Third-party (iText/TCPDF) & Generate official documents (e-Transcript). Formats: .PDF. \\
\midrule
...
\toprule
\textbf{Standard/Protocol} & \textbf{Purpose} & \textbf{Notes} \\
\midrule
