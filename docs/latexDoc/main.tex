...
\begin{figure}[htbp]
    ...
    \framebox{\parbox{0.85\textwidth}{\centering
      \vspace{0cm}
      \includegraphics[width=0.85\textwidth]{images/1e.png}
      \vspace{0cm}
    }}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/2e.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/3e.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/4e.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/5e.png}
